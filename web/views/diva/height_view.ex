defmodule Exblur.Diva.HeightView do
  use Exblur.Web, :view
  import Exblur.WebView

  def page_title(:index, _assigns), do: gettext("diva height index page title") <> " - " <> gettext("Default Page Title")
  ...
  def page_description(:index, _assigns), do: gettext("diva height index page title with %{name}", name: gettext("Site Name"))
